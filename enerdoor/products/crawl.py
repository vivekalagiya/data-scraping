...
SITE_CONFIG = {
    ...
    "part": {
        ...
        "main_selector": ".container",

        "markdown": [".woocommerce-product-details__short-description"],
    ...
    def images(soup, url):
        ...
        for sel in SITE_CONFIG["part"]["images"]:
            ...
            for img in soup.select(sel):
                ...
                img_url = img.get("data-large_image") or img.get("src") or img.get("data-src")
...
class Core:
    ...
    def get_requests(url, headers=None, timeout=60,stream=False, retries=3):
     ...
     "Connection": "keep-alive"
        ...
        logger.error("❌ All request attempts failed and Zyte API not configured.")
