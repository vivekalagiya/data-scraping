...
ZYTE_API_KEY = None  # set this in your environment
...
SITE_CONFIG = {
 ...
 "group": {
    "main_selector": "td.oe_product",
    "product_container": "td.oe_product",
    "markdown": ["h1"],
    "documentation": [],
    "products": {
        "name": "td.oe_product a",
        "sku": "",
        "product_page_link": "td.oe_product a",
        "pdf_link": "",
        "pdf_filename": "",
        "image_url": "td.oe_product img",
        "pricing": "",
        "description": ""
    }
 },
...
def init(url, update_prices_only=False):
    ...
    try:
        ...
        if not html:
            ...
            return None
        soup = BeautifulSoup(html, "html.parser")
        # FORCE PRODUCT PAGE DETECTION
        if "/catalog/" in url and "?category=" in url:
            crawl_array = {}
    ...
    # Group / Sub-category (product listings)
